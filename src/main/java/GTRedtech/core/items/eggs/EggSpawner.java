package GTRedtech.core.items.eggs;
...
public class EggSpawner extends ItemMonsterPlacer {
    ...
    public EggSpawner(String parEntityToSpawnName, int parPrimaryColor,
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ)
    {
        ...
        {
            entityToSpawnNameFull = GTRedtech.MODID+"."+entityToSpawnName;
